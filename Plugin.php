...
class Plugin extends PluginBase {
	...
	public function registerPermissions(){
        ...
        return [
            ...
            'janvince.smallcontactform.delete_messages' => [
                'label' => 'janvince.smallcontactform::lang.permissions.delete_settings',
				'tab' => 'janvince.smallcontactform::lang.plugin.name',
            ],
	...
	public function registerListColumnTypes()
	{
	    return [
	        ...
	        'switch_icon_star' => function($value) { return '<span class="'. ($value==1 ? 'oc-icon-circle text-success' : 'text-muted oc-icon-circle text-draft') .'">' . ($value==1 ? e(trans('janvince.smallcontactform::lang.models.message.columns.new')) : e(trans('janvince.smallcontactform::lang.models.message.columns.read')) ) . '</span>'; },
